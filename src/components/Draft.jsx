...
export default function Draft() {
  ...
  return (
    <>
      <div className="w-[85.4vw] max-[1200px]:w-full flex flex-col bg-[#f1f8fd] items-center gap-4 h-[100vh] text-[#111] border-r border-[#adadad]" id="mainDiv">
        <div className="flex items-center w-full border-b border-[#adadad] max-[1200px]:w-full   px-4 min-h-[54px] justify-between">
          ...
          id="button"
        onClick={clearDrafts} 
        className="py-2 px-3 text-[#ffffff] bg-[#111] hover:bg-stone-700 rounded-lg active:scale-95 mr-8"
        >Clear Draft
        </button>
        </div>
        ...
        <div className="w-[94%] h-auto flex flex-col gap-[6px] pb-3 overflow-auto">
          {draftEmails.length > 0 ? (
           ...
           <div className="w-[80vw] relative px-6 py-20 border-2 border-[#adadad] rounded-lg h-[80vh] bg-[#f1f8fd]" id="modal">
           ...
           onClick={handleCloseModal}
            className="absolute top-5 right-5 leading-none flex items-center justify-center p-2 text-3xl rounded-full border-2 border-[#adadad] text-[#111] bg-[#fff] hover:bg-stone-300 active:scale-95 ">
