    ...
    return(
        <div className="w-[432px] flex flex-col items-center gap-4 h-[100vh]  border-r border-[#adadad]">
                    ...
                    <div className="w-[94%] h-auto flex flex-col gap-[6px] pb-3 overflow-auto">
                        ...
                        <div className="w-full h-[148px] hover:bg-[#c9c9c9] cursor-pointer transition-all duration-300 border border-[#adadad] text-left rounded-lg py-2 px-3 flex flex-col gap-1">
